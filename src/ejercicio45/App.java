...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Introduzca el dígito que quiere modificar: ");
        ...
        if(digitos<2)
            ...
            long resultado = (long)(primero*Math.pow(10,digitos-posicion+1) +insertar*Math.pow(10, digitos - posicion )+(segundo%Math.pow(10, digitos-posicion)));
